...
- **Appendix-Estimates-and-Financial.docx** development cost, run cost implications, assumptions and contingency. Use the [IT Cost estimation template](../../content/lifecycle-stages/supporting-materials/align-and-plan/deliverables/IT%20Cost%20estimation%20template.xlsx) to build your cost input.
...
### Product Manager
- usually leads the overall shaping and ensures the value case, priorities and business context are clear

### Head of Product
- ensures the pack reflects a realistic product commitment, including delivery setup, lifecycle implications and product ownership

### Business Owner
- provides business context, expected outcomes and the business side decision input

### Product Owner
- helps shape the initial scope, priorities and high level backlog view

### Product Architect
- provides the high level technical direction, non functional scope and enabling needs

### IT Delivery Lead
- supports the shaping of delivery approach, dependencies, estimates and risk view
...
This deliverable should support approval, but it should also help the team move into execution with a shared understanding of the commitment.
