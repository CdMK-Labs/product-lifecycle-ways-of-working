...
- Is the product stable, available and performing as expected?
- Are incidents, alerts and operational issues being handled effectively?
...
- handle incidents, operational issues and service requests as relevant
- follow up on alerts, recurring problems and degradation patterns
...
- service management and support processes relevant to the product
- security, architecture and operational guardrails
- service level expectations and operational commitments
- dependency coordination with platforms, support teams and other products
- fundamentals that define the common playing field for stable, secure and responsible live operation
