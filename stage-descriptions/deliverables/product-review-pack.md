...
Your recurring review document. Covers operational health, usage and adoption signals, improvement decisions, key actions and owners.
...
- service dashboards
- incident summaries
- adoption or usage dashboards
- KPI views
- feedback summaries
- technical debt logs
- improvement backlogs
- action logs from prior reviews
...
- service overview
- service levels or operational commitments
- incidents and trends
- recurring issues or workarounds
- monitoring and alert signals
- maintenance actions
- operational risks

Should make the live condition of the product visible without becoming a detailed incident report.

### 4. Measurement & Learning
Usage, adoption and outcome signals. Typically includes:
- leading KPIs
- lagging KPIs
- adoption metrics
- usage patterns
...
Should help the team and the business discuss what the signals mean, not only display numbers.

### 5. Optimization & Lifecycle Decisions
Improvement needs and lifecycle choices. Typically includes:
- prioritised improvement opportunities
- technical debt items
- reliability or resilience actions
- simplification opportunities
- retirement candidates
- recommendation on next path where relevant

Should turn insight into product decisions.

### 6. Key decisions
The main decisions made in the review: what was agreed, challenged or escalated.

### 7. Actions, owners and dates
What happens next, who owns it and by when. This section ensures the review leads to action rather than passive reporting.

### 8. Owner and contributors
