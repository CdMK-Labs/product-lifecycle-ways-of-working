...
- product and business stakeholders need insight into what is happening in practice

This stage continues in parallel with Operate & Monitor as long as the product is active in use.
...
- access to relevant product, usage or adoption data where possible
...
Easy metrics are not always meaningful metrics. The point is to create useful insight, not just data volume.
