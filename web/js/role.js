(function () {
  ...
  fetch('../../content/roles-and-responsibilities/roles/' + role.id + '.md')
    .then(r => {
      if (!r.ok) throw new Error('Could not load ../content/roles-and-responsibilities/roles/' + role.id + '.md (' + r.status + ')');
      return r.text();
    })
    .then(md => {
