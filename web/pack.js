(function () {
  var PACKS = [
    { id: 'opportunity-brief',                        title: 'Opportunity Brief',                       color: '#0D6A4B', zip: 'opportunity-brief-starter-pack.zip',                note: 'Includes a main pack placeholder. Starter files will be expanded in future versions.' },
    { id: 'discovery-pack',                           title: 'Discovery Pack',                          color: '#0C563D', zip: 'discovery-pack-starter-pack.zip',                   note: 'Includes a main pack placeholder. Starter files will be expanded in future versions.' },
    { id: 'business-case-and-delivery-decision-pack', title: 'Business Case & Delivery Decision Pack',  color: '#0B885A', zip: 'business-case-delivery-decision-starter-pack.zip',  note: 'Includes a main pack and four appendix placeholders. Starter files will be expanded in future versions.' },
    { id: 'delivery-pack',                            title: 'Delivery Pack',                           color: '#0D6A4B', zip: 'delivery-pack-starter-pack.zip',                    note: 'Includes a main pack placeholder. Starter files will be expanded in future versions.' },
    { id: 'release-and-readiness-pack',               title: 'Release & Readiness Pack',                color: '#02462F', zip: 'release-readiness-starter-pack.zip',                note: 'Includes a main pack placeholder. Starter files will be expanded in future versions.' },
    { id: 'product-review-pack',                      title: 'Product Review Pack',                     color: '#2DA973', zip: 'product-review-pack-starter-pack.zip',              note: 'Includes a main pack placeholder. Starter files will be expanded in future versions.' },
  ];
